...
"Jt","invalid option. Dimension index exceeds the number of dimensions. Number of dimensions: %d. Value: `%d`.","RangeError"
"Ju","invalid argument. Third argument must be an array of integers. Value: `%s`.","TypeError"
"Jv","invalid option. `%s` option must be a negative integer. Option: `%s`.","TypeError"
"Jw","invalid argument. Specified dimension index is out-of-bounds. Must be on the interval: [-%u, %u]. Value: `%d`.","RangeError"
"Jx","invalid argument. Product of the sizes must be equal to the size of the dimension to be unflattened. Dimension: %d. Size: %d. Value: `[%s]`.","RangeError"
...
"Jz","%s %s failed with exit code: %s.","Error"
"K0","%s %s failed due to termination signal: %s.","Error"
"K1","invalid argument. Fourth argument must be an ndarray-like object. Value: `%s`.","TypeError"
